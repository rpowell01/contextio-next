 ...
 */
async function servePublicAsset(req, res, publicDir) {
    const url = req.url || "";
 ...
 */
export function createCombinedProxy(config) {
    ...
    const combinedHandler = async (req, res) => {
        ...
        function isPublicAsset(pathname) {
            return (pathname === "/site.webmanifest" ||
        ...
        async start() {
            ...
            return new Promise((resolve, reject) => {
                ...
                server.listen(resolved.port, resolved.bindHost, () => {
                    ...
                    console.log(`@contextio/proxy + Next.js running on http://${resolved.bindHost}:${boundPort}`);
                    resolve();
                });
            });
        },
...
//# sourceMappingURL=combined-server.js.map