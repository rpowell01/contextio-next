 ...
 */
export const ROLE_CONFUSION_PATTERNS = [
 ...
 */
export const SUSPICIOUS_UNICODE = /[\u200B-\u200F\u2028-\u202F\uFEFF\u061C\u115F\u1160\u17B4\u17B5\u180E\u2000-\u200A\u2060-\u2064\u2066-\u2069\u206A-\u206F]|\u00AD|\u034F/;
// ----------------------------------------------------------------------------
...
export const CREDENTIAL_PATTERNS = [
    ...
    },
    {
        ...
        pattern: /[\w.-]{0,50}?(?:access|auth|api|API|credential|creds|key|passw(?:or)?d|secret|token)(?:[\w.-]{0,20})[\s'"]{0,3}(?:=|:{1,3}=|:|,|>)[\x60'"\s=]{0,5}([\w.=\-+\/]{10,150})(?:[\x60'"\s;]|\\[nr]|$)/im,
        minEntropy: 3.0,
        allowlist: [
 ...
 */
export function truncateMatch(text, start, length) {
