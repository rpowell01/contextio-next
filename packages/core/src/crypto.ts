 ...
 */
export async function encrypt(plaintext: string, password: string): Promise<{ ciphertext: string; salt: string; iv: string }> {
 ...
 */
export async function decrypt(payload: string | { ciphertext: string; salt: string; iv: string }, password: string): Promise<string> {
