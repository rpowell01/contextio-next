			...
			try {
				...
				const metadata: RedactionMetadata = {
					...
					timings: parsedMeta.timings && typeof parsedMeta.timings === "object" ? {
						send_ms: typeof (parsedMeta.timings as Record<string, unknown>).send_ms === "number" ? (parsedMeta.timings as Record<string, unknown>).send_ms as number : undefined,
						wait_ms: typeof (parsedMeta.timings as Record<string, unknown>).wait_ms === "number" ? (parsedMeta.timings as Record<string, unknown>).wait_ms as number : undefined,
						receive_ms: typeof (parsedMeta.timings as Record<string, unknown>).receive_ms === "number" ? (parsedMeta.timings as Record<string, unknown>).receive_ms as number : undefined,
						total_ms: typeof (parsedMeta.timings as Record<string, unknown>).total_ms === "number" ? (parsedMeta.timings as Record<string, unknown>).total_ms as number : undefined,
					} : undefined,
