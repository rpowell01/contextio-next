 ...
 */
export declare const detectorRegistry: Map<string, DetectorFactory>;
/**
 * Register a detector factory.
 */
export declare function registerDetector(name: string, factory: DetectorFactory): void;
/**
 * Create a detector by name.
 */
export declare function createDetector(name: string, config: DetectorConfig): Promise<Detector>;
