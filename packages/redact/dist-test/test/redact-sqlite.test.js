...
import { createRedactPlugin } from "../dist/index.js";
...
async function setupTestDb() {
    ...
    const schema = db.prepare("PRAGMA table_info(redaction_metadata)").all();
...
//# sourceMappingURL=redact-sqlite.test.js.map